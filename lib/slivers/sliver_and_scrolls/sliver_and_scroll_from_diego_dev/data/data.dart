import 'package:flutter_animations_2/slivers/sliver_and_scrolls/sliver_and_scroll_from_diego_dev/models/product_category.dart';

final products = [
  Product(
    name: 'Choclate Cake',
    image: 'assets/sliver_with_scrollable_tabs/choclate_cake.png',
    description:
  ...
  Product(
    name: 'Cookies',
    image: 'assets/sliver_with_scrollable_tabs/cookies.jpg',
    description:
  ...
  Product(
    name: 'French Fries',
    image: 'assets/sliver_with_scrollable_tabs/french_fries.jpg',
    description:
  ...
  Product(
    name: 'Ceviche',
    image: 'assets/sliver_with_scrollable_tabs/ceviche.jpeg',
    description:
