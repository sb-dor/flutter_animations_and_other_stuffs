...
class _ComparisonsDetailsState extends State<ComparisonsDetails> {
  ...
  bool _startedToScrollPageView = false;
  double _scrollingTextOffset = 0.0;
  ...
  void initState() {
    ...
    for (int i = 0; i < ListViewModel.comparisons.length; i++) {
      ...
      scrollController.addListener(() => _listViewListener(scrollController));
  ...
  void _pageViewListener() {
    ...
    if (normalizedPage > 0.0 && !_startedToScrollPageView) {
      _startedToScrollPageView = true;
      setState(() {});
    } else if (normalizedPage <= 0.0 && _startedToScrollPageView) {
      _startedToScrollPageView = false;
      setState(() {});
    }
  }

  void _listViewListener(ScrollController controller) {
    if (!_startedToScrollPageView) {
      setState(() {
        _scrollingTextOffset = controller.offset;
      });
    }
  }
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            // Характеристики
            Positioned(
              top: (205 + _kButtonsHeight + _kDividerHeight) - _scrollingTextOffset,
              left: 5,
            ...
            // Цена
            Positioned(
              top: (250 + _kButtonsHeight + _kDividerHeight) - _scrollingTextOffset,
              left: 5,
              child: const SizedBox(
                height: 30,
                child: TextWidget(
            ...
            // Пробег
            Positioned(
              top: (310 + _kButtonsHeight + _kDividerHeight) - _scrollingTextOffset,
              left: 5,
              child: const SizedBox(
                height: 30,
                child: TextWidget(
            ...
            // Состояние
            Positioned(
              top: (375 + _kButtonsHeight + _kDividerHeight) - _scrollingTextOffset,
              left: 5,
              child: const SizedBox(
                height: 30,
                child: TextWidget(
            ...
            // Цвет
            Positioned(
              top: (440 + _kButtonsHeight + _kDividerHeight) - _scrollingTextOffset,
              left: 5,
              child: const SizedBox(
                height: 30,
                child: TextWidget(
            ...
            // Таможня
            Positioned(
              top: (505 + _kButtonsHeight + _kDividerHeight) - _scrollingTextOffset,
              left: 5,
              child: const SizedBox(
                height: 30,
                child: TextWidget(
            ...
            // Объем
            Positioned(
              top: (570 + _kButtonsHeight + _kDividerHeight) - _scrollingTextOffset,
              left: 5,
              child: const SizedBox(
                height: 30,
                child: TextWidget(
            ...
            // Двигатель
            Positioned(
              top: (635 + _kButtonsHeight + _kDividerHeight) - _scrollingTextOffset,
              left: 5,
              child: const SizedBox(
                height: 30,
                child: TextWidget(
            ...
            // Мощность
            Positioned(
              top: (700 + _kButtonsHeight + _kDividerHeight) - _scrollingTextOffset,
              left: 5,
              child: const SizedBox(
                height: 30,
                child: TextWidget(
