          ...
          children: [
            ...
            ClipPath(
              ...
              child: Container(
                ...
                color: Colors.pink,
                child:
                    const Center(child: Text("MultipleRoundedCurveClipper()")),
              ),
            ),
            const SizedBox(
              height: 20.0,
            ...
            ClipPath(
              ...
              child: Container(
                ...
                color: Colors.green,
                child:
                    const Center(child: Text("MultiplePointedEdgeClipper()")),
              ),
            ),
            const SizedBox(
              height: 20.0,
            ...
            ClipPath(
              ...
              child: Container(
                ...
                color: Colors.deepPurple,
                child:
                    const Center(child: Text("WaveClipperOne(reverse: true)")),
              ),
            ),
            const SizedBox(
              height: 10.0,
            ...
            ClipPath(
              ...
              child: Container(
                ...
                color: Colors.orange,
                child:
                    const Center(child: Text("WaveClipperTwo(reverse: true)")),
              ),
            ),
            const SizedBox(
              height: 10.0,
            ...
            ClipPath(
              ...
              child: Container(
                ...
                child:
                    const Center(child: Text("RoundedDiagonalPathClipper()")),
              ),
            ),
            const SizedBox(
              height: 10.0,
